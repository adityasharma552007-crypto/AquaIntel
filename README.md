# 🥛 AquaIntel — Safe Water. Scanned in Seconds.
...
**AquaIntel** is a sophisticated IoT-integrated web application designed to detect water adulteration in seconds using NIR (Near-Infrared) spectral analysis. Built for families and food safety enthusiasts in India, it brings laboratory-grade testing to the palm of your hand.
...
*   **PDF Generation:** [@react-pdf/renderer](https://react-pdf.org/) for generating downloadable water safety reports.

### 📡 IoT / Hardware Integration
*   **Device:** ESP8266 / ESP32 based **AquaIntel Pod**.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/your-username/waterguard-web.git
   cd waterguard-web
   ```
...
AquaIntel compares all detected samples against **FSSAI (Food Safety and Standards Authority of India)** 2025-26 safety limits to ensure legal and health compliance.
...
AquaIntel is available as an Android APK for on-the-go water testing.

### Download

Get the official APK from our download page:
**[Download AquaIntel APK](https://waterguard.vercel.app/download)**
...
3. **Install**: Open Downloads folder and tap `AquaIntel.apk`
...
For support, contact: support@waterguard.app
