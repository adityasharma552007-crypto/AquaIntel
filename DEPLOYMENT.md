# AquaIntel APK Deployment Guide

Complete guide for deploying the AquaIntel Android APK download page.

---

## Quick Start Checklist

- [ ] APK built and placed at `public/downloads/AquaIntel.apk`
...
```bash
cd /media/aditya-sharma/4E8C0ED58C0EB80B/WaterGaurd/android
...
mkdir -p /media/aditya-sharma/4E8C0ED58C0EB80B/WaterGaurd/web/public/downloads

# Copy APK
cp /path/to/your/app-release.apk /media/aditya-sharma/4E8C0ED58C0EB80B/WaterGaurd/web/public/downloads/AquaIntel.apk

# Verify file is readable
chmod 644 /media/aditya-sharma/4E8C0ED58C0EB80B/WaterGaurd/web/public/downloads/AquaIntel.apk
```
...
Edit `/media/aditya-sharma/4E8C0ED58C0EB80B/WaterGaurd/web/public/downloads/version.json`:

```bash
# Get APK file size
du -h public/downloads/AquaIntel.apk

# Get file size in bytes (for sizeBytes field)
stat -c%s public/downloads/AquaIntel.apk
```
...
```bash
cd /media/aditya-sharma/4E8C0ED58C0EB80B/WaterGaurd/web
...
### Test version.json
```bash
curl -s https://waterguard.vercel.app/downloads/version.json | jq
```

### Test APK download
```bash
# Check headers
curl -I https://waterguard.vercel.app/downloads/AquaIntel.apk

# Download and verify
curl -L -o /tmp/test-waterguard.apk https://waterguard.vercel.app/downloads/AquaIntel.apk
file /tmp/test-waterguard.apk
```
...
```
NEXT_PUBLIC_SITE_URL=https://waterguard.vercel.app
```
...
For issues, contact: support@waterguard.app
