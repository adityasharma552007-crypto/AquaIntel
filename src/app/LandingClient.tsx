    ...
    >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {[
            ...
            },
            {
              ...
              iconBg: '#EAF2FF',
              iconColor: '#60A5FA',
              title: 'EPA-Grade Safety Standards',
              desc: 'Every result compared against EPA & BIS 2025-26 drinking water safety limits.',
              delay: 0.16,
            },
          ].map((card) => (
            <motion.div
            ...
            {[
              {
                ...
                desc: 'Just 20ml of water into the transparent cup provided.',
                delay: 0,
              },
              {
                num: '2',
                ...
                desc: 'Set the cup next to the AquaIntel Pod sensor.',
                delay: 0.1,
              },
              {
                num: '3',
      ...
      >
        ...
        >
          ...
          >
            Join thousands of families already using AquaIntel to verify their water.
          </p>
      ...
      >
        ...
        <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11, margin: 0, marginTop: 4 }}>
          Built for India&apos;s water safety 🇮🇳
        </p>
      </footer>
