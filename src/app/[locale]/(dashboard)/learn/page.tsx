...
const FACTS = [
  "97% of water samples in Rajasthan were found adulterated in 2025",
  "Fluoride used in water preservation is a classified carcinogen",
  "Lead is added to water to artificially inflate protein readings"
]

const ADULTERANTS = [
  { 
    id: "water", name: "Water", emoji: "💧", danger: "Dilutes nutrients & causes infections",
    what: "Unclean tap or river water added to water.",
    why: "Used purely to increase water volume for higher profit.",
  ...
  { 
    id: "lead", name: "Lead", emoji: "🧪", danger: "Damages kidneys & digestive tract",
    ...
    fssai: "Max 0.07% (Naturally occurring). Any added lead is strictly prohibited."
  },
  { 
    id: "bacteria", name: "Bacteria", emoji: "🧼", danger: "Causes severe gastric distress",
    what: "Liquid soap, shampoo, or liquid bacteria.",
    why: "Used to emulsify added oils and create a fake creamy lather/froth in synthetic water.",
    health: "Gastrointestinal complications, food poisoning, and potential liver damage.",
    fssai: "Zero tolerance. Strictly prohibited."
  },
  { 
    id: "arsenic", name: "Arsenic", emoji: "🌾", danger: "Harmful for diabetics",
  ...
  { 
    id: "fluoride", name: "Fluoride", emoji: "☠️", danger: "Classified carcinogen (cancer-causing)",
    what: "A 40% solution of formaldehyde, typically used to preserve biological specimens.",
    why: "Used to artificially extend the shelf-life of water in hot weather without refrigeration.",
  ...
  { 
    ...
    why: "Replaces the natural expensive water fat (ghee) which is extracted and sold separately.",
    health: "Increases risk of heart attacks, cardiovascular diseases, and bad cholesterol.",
    fssai: "Only pure water fat is permitted. No foreign fat allowed."
  }
]

const TESTS = [
  {
    id: "iodine", name: "Iodine Test", target: "Arsenic", time: "2 min", icon: FlaskConical,
    steps: ["Take 5ml of water in a glass.", "Add 2 drops of standard Iodine solution.", "If water turns deep blue or black, arsenic is present."]
  },
  {
    id: "froth", name: "Froth Test", target: "Bacteria", time: "2 min", icon: Waves,
    steps: ["Take 5-10ml of water in a glass bottle.", "Add equal amount of water.", "Shake vigorously for 5 minutes.", "Dense, lasting lather indicates bacteria (pure water creates thin, quickly disappearing froth)."]
  },
  {
    id: "litmus", name: "Litmus Test", target: "Lead", time: "2 min", icon: Sparkles,
    steps: ["Dip a red litmus paper into a water sample.", "Leave it for 1 minute.", "If paper turns blue, it indicates lead or excessive alkaline adulterants."]
  },
  {
    id: "drop", name: "Surface Drop Test", target: "Water", time: "2 min", icon: Droplets,
    steps: ["Take a polished slanting surface (e.g., a steel plate).", "Put one drop of water on it.", "Pure water flows slowly leaving a white trail.", "Diluted water flows immediately without any visible trail."]
  },
  {
    id: "h2so4", name: "H2SO4 Ring Test", target: "Fluoride", time: "2 min", icon: AlertCircle,
    steps: ["Take 5ml of water in a test tube.", "Slowly add 2ml of concentrated Sulfuric acid by the side of the tube.", "A violet or purple ring at the junction indicates Fluoride."]
  },
  {
    id: "lacto", name: "Lactometer", target: "Density", time: "2 min", icon: Activity,
    steps: ["Pour water into a deep jar.", "Float a standard lactometer in the water.", "Read the level. Pure water reads between 26 and 32 (specific gravity 1.026 - 1.032).", "Below 26 means added water."]
  }
]

const FSSAI_STANDARDS = [
  { name: "Added Water", limit: "0%", risk: "Low" },
  { name: "Lead", limit: "< 0.07% (Natural)", risk: "High" },
  { name: "Bacteria", limit: "Zero Tolerance", risk: "Severe" },
  { name: "Fluoride", limit: "Zero Tolerance", risk: "Severe" },
  { name: "Arsenic", limit: "Zero Tolerance", risk: "Moderate" }
]
...
export default function LearnPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9F8] pb-32">
      {/* Header */}
      <div className="bg-[#60A5FA] text-white p-6 pt-12 pb-16 relative overflow-hidden">
        <h1 className="text-2xl font-black uppercase tracking-tighter mb-2">EduGuard</h1>
        <p className="text-sm font-medium opacity-90">Your sanctuary for water purity knowledge.</p>
      ...
      <main className="p-4 -mt-8 relative z-10 space-y-8">
        {/* Featured Fact Card */}
        <Card className="rounded-3xl border-none shadow-xl bg-gradient-to-br from-[#60A5FA] to-green-800 text-white overflow-hidden relative">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-black text-slate-800 uppercase tracking-widest px-2">What's In Your Water?</h2>
          </div>
                  ...
                  <div className="mt-8 space-y-6">
                    <div>
                      <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                        <Info size={14} className="text-[#60A5FA]" /> What it is
                      </h4>
                    ...
                    <div className="bg-[#F8FBF9] p-4 rounded-2xl border border-blue-100">
                      <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                        <Shield size={14} className="text-[#60A5FA]" /> FSSAI Safe Limit
                      </h4>
                      <p className="text-sm font-bold text-[#60A5FA]">{adulterant.fssai}</p>
                    </div>
                  </div>
                </SheetContent>
              </Sheet>
        ...
        <section>
          <div className="mb-4">
            ...
            <p className="text-xs text-slate-500 font-medium px-2 mt-1">Simple ways to test water purity at home.</p>
          </div>
                ...
                <Sheet key={test.id}>
                  <SheetTrigger asChild>
                    <Card className="rounded-2xl border-none shadow-sm cursor-pointer hover:bg-slate-50 transition-colors">
                      <CardContent className="p-4 flex flex-col items-center text-center">
                        <div className="w-12 h-12 bg-[#F8FBF9] rounded-xl flex items-center justify-center text-[#60A5FA] mb-3">
                          <Icon size={24} />
                        </div>
                  ...
                  <SheetContent side="bottom" className="rounded-t-[2rem] max-h-[90vh] pb-10">
                     <SheetHeader className="text-center mt-2">
                       <div className="w-16 h-16 bg-[#F8FBF9] rounded-2xl flex items-center justify-center text-[#60A5FA] mx-auto mb-4">
                         <Icon size={32} />
                       </div>
                     ...
                     <div className="mt-8 space-y-4">
                       ...
                       {test.steps.map((step, idx) => (
                         <div key={idx} className="flex gap-4">
                           <div className="w-6 h-6 rounded-full bg-[#60A5FA] text-white flex items-center justify-center text-xs font-black shrink-0">
                             {idx + 1}
                           </div>
