...
// Example: NEXT_PUBLIC_SITE_URL=https://aquaintel.vercel.app
...
export const metadata: Metadata = {
  ...
  description:
    "Detect water adulteration instantly with AI-powered spectral analysis. Contactless water purity testing with FSSAI-compliant reporting. Protect your family from harmful adulterants.",
  ...
  openGraph: {
    ...
    description:
      "Detect water adulteration instantly with AI-powered spectral analysis. Contactless, FSSAI-compliant water purity testing.",
    images: [
      {
...
const jsonLd = {
  ...
  operatingSystem: "Web",
  description: "AI-powered water adulteration detection system using spectral analysis",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "INR",
