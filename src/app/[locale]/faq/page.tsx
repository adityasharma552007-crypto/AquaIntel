...
const faqs = [
  {
    question: 'What is water adulteration and why is it dangerous?',
    answer: 'Water adulteration is the practice of adding harmful substances to water to increase quantity or mask poor quality. Common adulterants include lead (used as fertilizer), bacteria (creates false froth), fluoride (preservative), and arsenic (thickens water). These substances can cause serious health issues including kidney damage, digestive problems, and long-term toxicity. According to FSSAI, over 97% of water samples in some Indian states contain harmful adulterants.',
  },
  {
    question: 'How does AquaIntel detect water adulteration?',
    answer: 'AquaIntel uses near-infrared (NIR) spectral analysis combined with AI-powered detection. When you place a water sample in the Pod, it emits 18 different wavelengths of light through the water. Each substance absorbs light differently, creating a unique "spectral fingerprint." Our AI model analyzes this fingerprint and compares it against known adulterant patterns to identify contaminants in just 8 seconds.',
  },
  {
    question: 'How accurate is the AquaIntel test?',
    answer: 'AquaIntel achieves 93-97% accuracy for detecting common adulterants like lead, bacteria, and fluoride when compared to standard laboratory methods. The accuracy depends on adulterant concentration — higher concentrations are detected more reliably. While AquaIntel provides reliable results for daily household use, laboratory confirmation is recommended for legal disputes or official compliance documentation.',
  },
  {
    question: 'What adulterants can AquaIntel detect?',
    answer: 'AquaIntel currently detects 7+ common adulterants: Lead, Bacteria, Fluoride, Arsenic, Iron, Nitrates (Sodium Chloride), and Turbidity. We continuously update our AI model to detect additional adulterants as new threats emerge. Each adulterant has a distinct spectral signature that our system learns to recognize.',
  },
  {
    question: 'Is the test safe? Does the water get contaminated?',
    answer: 'Yes, the test is completely safe! AquaIntel uses contactless NIR spectroscopy — the water never touches the device. Light passes through the container to analyze the water. After testing, the water is safe to consume (unless the test reveals adulteration, in which case you should discard it). No chemicals, no reagents, no contamination.',
  },
  {
    question: 'How much water do I need for a test?',
    answer: 'You only need approximately 20ml of water — about 2-3 tablespoons. This small amount is sufficient for accurate spectral analysis. The water should be at room temperature for best results. Extreme temperatures (very hot or very cold) can affect the accuracy of the reading.',
  },
  {
    question: 'What is the SafetyScore?',
    answer: 'The SafetyScore is a 0-100 rating that summarizes your water\'s overall quality. A score of 90-100 indicates excellent quality with no detected adulterants. 70-89 means acceptable quality with minor concerns. Below 70 indicates significant adulteration detected. The score is calculated based on the type and concentration of any detected adulterants, compared against FSSAI safety limits.',
  },
  {
    question: 'Can I use AquaIntel results for legal purposes?',
    answer: 'AquaIntel results are intended for personal household use and awareness. While highly accurate, they are not legally binding for disputes or official compliance documentation. For legal purposes, you would need testing from an FSSAI-certified laboratory. However, AquaIntel results can help you decide when to seek official testing.',
  },
  {
    question: 'How do I connect the AquaIntel Pod device?',
    answer: 'To connect your AquaIntel Pod: (1) Ensure the Pod is powered on and within Bluetooth range. (2) Go to the Hardware page in the app. (3) Tap "Connect Device" and wait for pairing. (4) Once connected, you\'ll see a green status indicator. If connection fails, check that the Pod is charged and try restarting both the device and app.',
  },
  {
    question: 'What should I do if water is adulterated?',
    answer: 'If AquaIntel detects adulteration: (1) Do not consume the water. (2) Document the results with a screenshot or PDF report. (3) Contact your water vendor to report the issue. (4) Consider switching to a different vendor. (5) For repeated issues, you can report to FSSAI through their official complaint portal. Your safety is the priority.',
  },
  {
    question: 'Is AquaIntel approved by FSSAI?',
    answer: 'AquaIntel follows FSSAI 2025-26 safety standards and limits for all adulterant detection. While the device itself is not an FSSAI-certified laboratory, our detection thresholds and SafetyScore calculations are aligned with FSSAI regulations. We are working toward official FSSAI recognition for consumer-grade testing devices.',
  },
  {
    question: 'Can I test other dairy products besides water?',
    answer: 'Currently, AquaIntel is calibrated specifically for liquid water (cow, buffalo, and mixed). We are developing models for other dairy products like paneer, curd, and ghee. These will be added through firmware updates. Using AquaIntel for non-water substances may give inaccurate results.',
  },
]
      ...
      <div className="max-w-md mx-auto bg-white shadow-xl">
        ...
        <header className="bg-gradient-to-b from-[#60A5FA] to-[#3B82F6] text-white py-12 px-6">
          ...
          <PageSubtitle className="text-blue-200">
            Everything About Water Purity Testing
          </PageSubtitle>
        </header>
        ...
        <section className="py-8 px-6">
          <div className="bg-gradient-to-r from-[#60A5FA] to-[#3B82F6] text-white p-6 rounded-xl text-center">
            ...
            <p className="text-white/90 text-sm mb-4">
              Our AI chat assistant can help with specific questions about water testing, adulteration, and FSSAI standards.
            </p>
            <a
              href="/chat"
