/**
 * How It Works Page - AquaIntel
 *
 * SEO-optimized content explaining the water adulteration detection process.
  ...
  const howToJsonLd = generateHowToJsonLd([
    {
      ...
      text: 'Pour just 20ml of water into the transparent sample cup provided with your AquaIntel Pod.',
    },
    {
      name: 'Place in the Pod cradle',
      text: 'Set the cup next to the AquaIntel Pod sensor. The device will automatically detect the sample.',
    },
    {
      name: 'Start the scan',
      text: 'Click "Start Scan" in the app. The Pod emits 18 wavelengths of near-infrared light through the water sample.',
    },
    {
      name: 'AI analysis',
    ...
    <div className="min-h-screen bg-[#F7F9F8] pb-24">
      <div className="max-w-md mx-auto bg-white shadow-xl">
        ...
        <header className="bg-gradient-to-b from-[#1A6B4A] to-[#134f37] text-white py-12 px-6">
          <PageTitle as="h1" className="text-white mb-2">How AquaIntel Works</PageTitle>
        ...
        <section className="py-8 px-6">
          <SEOParagraph className="mb-4" highlightKeyword="water adulteration detection">
            AquaIntel uses <strong>near-infrared (NIR) spectral analysis</strong> — the same technology found in professional food testing laboratories — combined with advanced AI to detect water adulteration in just 8 seconds.
          </SEOParagraph>
          <SEOParagraph className="mb-4">
            Here's exactly how our <strong>contactless water purity testing</strong> system works, from sample to SafetyScore.
          </SEOParagraph>
        </section>
          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="relative pl-12 border-l-2 border-[#1A6B4A] pb-6">
              ...
              <p className="text-slate-600 text-sm mb-2">
                Pour approximately 20ml of water into the transparent sample cup. This small amount is sufficient for accurate analysis.
              </p>
            ...
            <div className="relative pl-12 border-l-2 border-[#1A6B4A] pb-6">
              ...
              <p className="text-slate-600 text-sm mb-2">
                Place the sample cup in the AquaIntel Pod cradle. Our device uses <strong>near-infrared light</strong> to scan the water without any physical contact or chemical reagents.
              </p>
              <div className="flex items-center gap-2 text-xs text-slate-500">
            ...
            <div className="relative pl-12 border-l-2 border-[#1A6B4A] pb-6">
              ...
              <p className="text-slate-600 text-sm mb-2">
                The Pod emits <strong>18 different wavelengths</strong> of NIR light (700-2500nm) through the water sample. Each component in the water absorbs light differently, creating a unique spectral fingerprint.
              </p>
              <div className="bg-slate-50 p-3 rounded-lg mt-2">
                <p className="text-xs text-slate-600">
                  <strong>Science:</strong> Different molecules absorb specific wavelengths of light. Lead, for example, has distinct absorption peaks at 1450nm and 1940nm.
                </p>
              </div>
            </div>
            ...
            <div className="relative pl-12 border-l-2 border-[#1A6B4A] pb-6">
              ...
              <div className="flex items-center gap-2 text-xs text-slate-500">
                ...
                <span>Trained on 10,000+ water samples</span>
              </div>
            </div>
        ...
        <section className="py-8 px-6 bg-slate-50">
          <h2 className="text-2xl font-black text-[#1A6B4A] mb-6 tracking-tight flex items-center gap-2">
            ...
            The Technology Behind AquaIntel
          </h2>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-slate-600">
                Our AI model is trained on over 10,000 water samples with known adulterant concentrations. It continuously improves with each scan, learning to detect even trace amounts of contaminants.
              </p>
            </div>
        ...
        <section className="py-8 px-6">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-4">
            ...
            <ul className="text-sm text-green-700 space-y-1">
              <li>• 97.5% accuracy for lead detection (≥50mg/dL)</li>
              <li>• 95.2% accuracy for bacteria detection</li>
              <li>• 94.8% accuracy for fluoride detection</li>
          ...
          <div className="space-y-4 mt-4">
            <div className="bg-slate-50 p-4 rounded-lg">
              <h4 className="font-bold text-[#1A6B4A] mb-2 text-sm">
                How accurate is AquaIntel compared to lab tests?
              </h4>
              <p className="text-sm text-slate-600">
                AquaIntel achieves 93-97% accuracy compared to standard laboratory methods. While not a replacement for certified lab testing in legal disputes, it provides reliable results for daily household use.
              </p>
            </div>
            ...
            <div className="bg-slate-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-slate-600">
                AquaIntel detects the 7+ most common adulterants: lead, bacteria, fluoride, arsenic, iron, nitrates, and turbidity. We're continuously adding new adulterant profiles through AI model updates.
              </p>
            </div>

            <div className="bg-slate-50 p-4 rounded-lg">
              <h4 className="font-bold text-[#1A6B4A] mb-2 text-sm">
                Does the water get wasted after testing?
              </h4>
              <p className="text-sm text-slate-600">
                No! The testing is completely contactless — the water never touches the device. You can safely use the tested water afterward.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 px-6">
          <div className="bg-gradient-to-r from-[#1A6B4A] to-[#134f37] text-white p-6 rounded-xl text-center">
            ...
            <p className="text-white/90 text-sm mb-4">
              Experience the future of water safety testing.
            </p>
            <a
              href="/scan"
