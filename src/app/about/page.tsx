...
const organizationJsonLd = {
  ...
  '@type': 'Organization',
  name: 'ARJUNAS',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://aquaintel.vercel.app',
    ...
    <div className="min-h-screen bg-[#F7F9F8] pb-24">
      <div className="max-w-md mx-auto bg-white shadow-xl">
        ...
        <header className="bg-gradient-to-b from-[#60A5FA] to-[#3B82F6] text-white py-12 px-6">
          <PageTitle as="h1" className="text-white mb-2">About AquaIntel</PageTitle>
        ...
        <section className="py-8 px-6">
          ...
          <SEOParagraph className="mb-4">
            AquaIntel was born from a simple yet powerful mission: <strong>to make safe water accessible to every Indian family</strong>. With water adulteration rates reaching alarming levels across India, we recognized the need for a fast, reliable, and accessible testing solution.
          </SEOParagraph>
          <SEOParagraph>
            Our <strong>AI-powered water adulteration detection system</strong> uses cutting-edge near-infrared (NIR) spectral analysis to identify harmful contaminants in just 8 seconds — no laboratory required.
          </SEOParagraph>
        </section>
          ...
          <div className="space-y-4 mt-4">
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-slate-600">
                of water samples in Rajasthan contain harmful adulterants (FSSAI 2025)
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <p className="text-3xl font-bold text-red-600 mb-1">7+</p>
              <p className="text-sm text-slate-600">
                Common adulterants including lead, bacteria, fluoride, and arsenic
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <p className="text-3xl font-bold text-red-600 mb-1">Millions</p>
              <p className="text-sm text-slate-600">
                of families exposed to health risks from contaminated water daily
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 px-6">
          <h2 className="text-2xl font-black text-[#3B82F6] mb-6 tracking-tight flex items-center gap-2">
            ...
            The AquaIntel Solution
          </h2>
          <SEOParagraph className="mb-4">
            AquaIntel combines <strong>hardware innovation with artificial intelligence</strong> to deliver laboratory-grade water testing in a portable, affordable device.
          </SEOParagraph>
        ...
        <section className="py-8 px-6">
          ...
          <SEOParagraph className="mb-4">
            We are a team of passionate developers, engineers, and food safety advocates dedicated to solving India's water adulteration crisis through technology.
          </SEOParagraph>
          <div className="bg-gradient-to-r from-[#60A5FA] to-[#3B82F6] text-white p-6 rounded-xl mt-4">
            ...
            <p className="text-blue-100 text-sm">
              AquaIntel is proudly developed in India, designed specifically for Indian water supply chains and FSSAI regulations. We understand the unique challenges Indian families face and have built a solution that works in real-world conditions.
            </p>
          </div>
        </section>
        ...
        <section className="py-8 px-6">
          ...
          <SEOParagraph className="mb-4">
            AquaIntel uses <strong>near-infrared (NIR) spectral analysis</strong> — the same technology used in professional food testing laboratories — miniaturized into an affordable consumer device.
          </SEOParagraph>
          <SEOParagraph className="mb-4">
            Our <strong>AI model analyzes 18 different wavelengths</strong> of light to create a unique spectral fingerprint for each water sample. This fingerprint is compared against our database of known adulterants to identify contaminants with high accuracy.
          </SEOParagraph>
        ...
        <section className="py-8 px-6 bg-gradient-to-br from-[#f5f0ff] to-white">
          ...
          <SEOParagraph className="mb-5">
            Every water scan on AquaIntel is permanently recorded on the{' '}
        ...
        <section className="py-8 px-6">
          <div className="bg-gradient-to-r from-[#F5A623] to-[#E8941A] text-white p-6 rounded-xl text-center">
            ...
            <p className="text-white/90 text-sm mb-4">
              Join thousands of families using AquaIntel to verify their water safety.
            </p>
            <a
              href="/scan"
        ...
        <footer className="py-8 px-6 text-center border-t">
          <p className="text-sm text-slate-500">
            AquaIntel © 2026 | Built by ARJUNAS 🇮🇳
          </p>
