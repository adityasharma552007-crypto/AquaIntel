        ...
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <Button asChild className="bg-blue-600 hover:bg-blue-700">
              <a href="/downloads/AquaIntel.apk" download>
                Download Directly
              </a>
            </Button>
          </CardContent>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-indigo-50 to-blue-100">
      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1 className="text-3xl font-bold mb-2">AquaIntel for Android</h1>
          <p className="text-blue-100 text-sm">AI-Powered Water Adulteration Detection</p>
        </div>
      </motion.header>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-xl flex items-center gap-2">
                    ...
                    {versionInfo?.filename || 'AquaIntel.apk'}
                  </CardTitle>
                  ...
                  <CardContent>
                    <ol className="space-y-3">
                      {[
                        ...
                        { step: 3, text: 'Open the Downloads app and tap on AquaIntel.apk' },
                        { step: 4, text: 'Tap "Install" when prompted' },
                        { step: 5, text: 'Once installed, tap "Open" to launch AquaIntel' },
                      ].map((item, index) => (
                        <motion.li
                          key={item.step}
                          initial={{ opacity: 0, x: -10 }}
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href="mailto:support@aquaintel.app" className="flex items-center gap-2">
                    Contact Support
      ...
      <footer className="max-w-2xl mx-auto px-4 py-6 text-center">
        <p className="text-slate-500 text-xs">
          AquaIntel v{versionInfo?.version} • Built with ❤️ for India&apos;s food safety
        </p>
      </footer>
    </div>
  )
