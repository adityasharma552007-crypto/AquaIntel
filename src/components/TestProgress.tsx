...
const ADULTERANTS: {
  ...
  { key: 'lead',      label: 'Lead',      safeLimit: 0.5, color: '#8b5cf6' },
  { key: 'arsenic',    label: 'Arsenic',    safeLimit: 0.5, color: '#f59e0b' },
  { key: 'bacteria', label: 'Bacteria', safeLimit: 0.3, color: '#06b6d4' },
]
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-1">
        ...
        <span className={`text-[10px] font-black ${isDanger ? 'text-red-500' : 'text-blue-400'}`}>
...
export function TestProgress() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-[#60A5FA] to-[#1e8259] px-5 py-4 flex items-center justify-between">
        <div>
        ...
        <div className="flex flex-col items-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              {testPhase === 'running' ? (
                <>
                  <span className="text-3xl font-black text-[#60A5FA] leading-none">
                    {Math.round(progress)}%
                  </span>
