 ...
 * EVENTS TRACKED:
 * - page_view (automatic)
 * - generate_lead (when user starts a water test)
 ...
 *
 * Usage examples:
 * - trackEvent('start_water_test', { method: 'hardware' })
...
/**
 * Track water test initiation (conversion event)
...
/**
 * Track completed water test with results
...
export function trackTestCompletion(params: {
  ...
  trackEvent('water_test_complete', {
